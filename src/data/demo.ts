...
/** Seed donors so priority assignment is visible before real profiles exist. */
export const DEMO_DONORS: DonorProfile[] = [
  {
    id: "demo-d1",
    fullName: "Ananya R.",
    bloodGroup: "O-",
  ...
  },
  {
    ...
    livesHelped: 9,
    avgResponseMinutes: 11,
    joinedAt: "2025-01-09T00:00:00.000Z",
  },
  {
    id: "demo-d4",
    fullName: "Rohit P.",
    ...
    joinedAt: "2025-08-21T00:00:00.000Z",
  },
  {
    id: "demo-d5",
    fullName: "Isha V.",
...
export const HOW_IT_WORKS = [
  ...
  },
  {
    ...
    title: "Match",
    description:
      "Donors are assigned by urgency first, then distance, then successful donation history.",
  },
  {
    step: "03",
    title: "Arrive",
